...
/**
 * Every window has a Scene that contains various nodes that add functionality
 * to the program.
 *
 */
public class Scene extends Node {
	...
	/**
	 * Sets the base node of the scene, essentially becoming the "container" for
	 * everything else.
	 * 
	 * @param node
	 */
