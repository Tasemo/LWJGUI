...
public class Context {
	...
	public void create(Window window) {
		...
		glfwSwapInterval(1); // TODO: VSync Context
	 ...
	 * Retina displays will commonly return 2. Screens with a larger pixel ratio
	 * pack more detail in a smaller space.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the viewport width for the context. Normally returns width, unless
	 * the pixel ratio is non 1.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the viewport height for the context. Normally returns height, unless
	 * the pixel ratio is non 1.
	 * 
	 * @return
	 */
